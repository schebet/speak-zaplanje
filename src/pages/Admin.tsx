...
import { Plus, LogOut, Trash2, Edit, Eye, EyeOff, Star, Sparkles, Loader2 } from "lucide-react";
        ...
        {showForm && (
          <div className="bg-card rounded-xl border border-border p-6 mb-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <div>
                <label className="text-sm font-medium text-foreground mb-1 block">URL слике</label>
